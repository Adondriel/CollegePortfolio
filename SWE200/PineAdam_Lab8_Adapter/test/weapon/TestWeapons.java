...
public class TestWeapons {
	...
	public void testPistol() throws WeaponException {
		...
		//fire the Pistol once at something in range (25)
		//damage should be 2
		assertEquals(2, p.fire(25)); 
		timer.timeChanged();
		//check the ammo is reduced by 1
		...
		//fire the Pistol once at something in range (20)
		//damage should be 4
		assertEquals(4, p.fire(20)); 
		//check the ammo is reduced by 1
	...
	public void testChainGun() throws WeaponException {
		...
		//fire the ChainGun once at something in range (25)
		//damage should be 12
		assertEquals(12, c.fire(25));
		timer.timeChanged();
		//check the ammo is reduced by 1
		...
		//fire the ChainGun once at something just in range (30)
		//damage should be 15
	...
	public void testPlasmaCannon() throws WeaponException{
		...
		//fire the PlasmaCannon once at something just in range (20)
	...
	public void testRoundUpdates() throws WeaponException
	{
		...
		//fire 1
		assertEquals(8, p.fire(10)); 
		assertEquals(50, pC.fire(10)); 
		assertEquals(5,c.fire(10)); 
