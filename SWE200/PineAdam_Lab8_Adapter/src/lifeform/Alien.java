...
public class Alien extends LifeForm implements TimerObserver {
	...
	private int recoveryRate; // Aliens recovery periodically. This alien
								// recovers every rR rounds
								// a recoveryRate of 0 means that this Alien
								// will never recover, even if it has a recovery
								// behavior
	/**
	 * Override the revive method, make it so that alien's can't respawn.
	 */
	@Override
	public void revive() {
	 ...
	 * Aliens have an attack strength of 10, by default Aliens have a recovery
	 * Rate of 0 (will never recover) by default Aliens have a maximum speed of
	 * 2 square per move
	 * 
	 * @param name
	 * @param maxHP
	 ...
	 * @param name
	 * @param maxHP
	 *            maximum possible life points, also the initial life points at
	 *            instantiation
	 * @param behavior
	 *            the way in which this Alien will recover life points
	 * @throws RecoveryRateException
	 *             this should never be thrown
	 */
	...
	/**
	 * Aliens have an attack strength of 10, by default Aliens have a maximum
	 * speed of 2 square per move
	 * 
	 * @param name
	 * @param maxHP
	 * @param behavior
	 * @param recoveryRate
	 *            Aliens can recover periodically. This specifies how often to
	 *            recover. A recovery rate of 1 means the Alien will recover
	 *            every round. A recovery rate of 0 means this Alien will never
	 *            recover points.
	 * @throws RecoveryRateException
	 *             thrown if the recoverRate is less than 0
	 */
	public Alien(String name, int maxHP, RecoveryBehavior behavior, int recoveryRate) throws RecoveryRateException {
		...
		recovery = behavior;
		if (recoveryRate < 0) {
			// still set recoveryRate to neg value. May come back and change
			// this.
