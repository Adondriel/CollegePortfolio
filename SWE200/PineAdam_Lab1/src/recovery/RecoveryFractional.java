...
public class RecoveryFractional implements RecoveryBehavior {
	...
	/**
	 * 
	 * @param percent double, multiplied by current life.
	 * Values less than 1 will subtract life, values over will add life.
	 * 1.5 = 50% recovery.
	 */
	...
	/**
	 * @param currentLife The amount of life the lifeform currently has.
	 * @param maxLife The max amount of life the lifeform can have.
	 */
	@Override
