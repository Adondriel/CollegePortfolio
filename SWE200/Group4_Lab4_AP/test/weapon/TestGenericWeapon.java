...
public class TestGenericWeapon {
	...
	public void testGWFireRate() throws InterruptedException {
		...
		Thread.sleep(1000);
		//This calls the updateTime method, which will reset the amount of shotsFired.
		//Some weapons may also need to reload at this time, so be sure to call that if your weapon does not have enough ammo.
