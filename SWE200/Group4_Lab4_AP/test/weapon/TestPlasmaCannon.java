...
public class TestPlasmaCannon {
	/**
	 * This weapon does not care about distance, other than max range.
	 * This weapon's damage depends on the current ammo of the gun. 
	 * This is the single test needed to ensure it calculates damage and reloads properly.
	 */
	@Test
