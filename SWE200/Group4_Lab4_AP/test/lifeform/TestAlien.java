...
public class TestAlien {
	...
	/**
	 * Tests the construction value of an alien's recov rate.
	 * Also tests the get and set recoveryRate() method.
	...
	//
	//EXTRA TESTS HERE:
	//These tests use an alien to do the attacking of the human, to ensure they all cooperate well.
	//
	/**
	 ...
	 */
	@Test
	public void testAlienAttackHumanNoArmor() throws RecovRateIsNegative{
		Alien a = new Alien("ET", 30, 1, new RecoveryLinear(3));
	 ...
	 */
	@Test
	public void testAlienAttackHumanDmgEqualArmor() throws RecovRateIsNegative{
		Alien a = new Alien("ET", 30, 1, new RecoveryLinear(3));
	 ...
	 */
	@Test
	public void testAlienAttackHumanSomeArmor() throws RecovRateIsNegative{
		Alien a = new Alien("ET", 30, 1, new RecoveryLinear(3));
