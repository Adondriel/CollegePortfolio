...
public abstract class GenericWeapon implements Weapon {
	...
	/**
	 * The default calcDmg() method, will return just the baseDamage of the weapon.
	 */
	@Override
	...
	/**
	 * Provides some common thigns that happen when shooting, does not actually shoot anything.
	 * This updates diff variables which are common occurences when shooting stuff.
	 */
