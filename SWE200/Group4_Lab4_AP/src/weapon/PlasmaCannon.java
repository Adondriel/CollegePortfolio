...
public class PlasmaCannon extends GenericWeapon {
	...
	/**
	 * The calcdmg() override to determine how much damage the plasmacannon will do.
	 * distance only effects if it can or cannot actually hit the target, 
	 * and does not change the amount of damage it does.
	 * Damage depends on the amount of ammo still in the gun.
	 */
	@Override
