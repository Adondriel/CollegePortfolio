...
public class Alien extends LifeForm {
	...
	/**
	 * Constructor that will default to a recoveryNone RB, defaults recov rate to 1.
	 ...
	 * @param recovRate How many ticks/rounds before the recover function will be called.
	 * @param rb The recovery behavior.
	 * if recovRate <0 throws error, if = 0 does nothing. This is checked later on aswell in the updateTime method.
	 */
