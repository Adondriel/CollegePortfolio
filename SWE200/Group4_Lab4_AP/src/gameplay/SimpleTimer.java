...
public class SimpleTimer extends Thread implements Timer{
	...
	private int loopAmount = 25;
	/**
	 * Constructor, initializes the tickrate.
	 * @param tickrate The amount of time between each tick update.
	 */
	 ...
	 * @param TimeObserver the TimeObserver to be added.
	 */
	@Override
	...
	/**
	 * @param TimeObserver The TimeObserver to be removed.
	 */
	@Override
	...
	/**
	 * When called will loop through the list of TimeObservers
	 * and then call each one's updateTime() method.
	 */
	@Override
	...
	/**
	 * The run method, will update the round amount, and then call the timeChanged() method.
	 */
	public void run(){
