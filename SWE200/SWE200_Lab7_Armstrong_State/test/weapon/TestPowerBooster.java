...
public class TestPowerBooster {
	...
	public void testPowerBoosterScopeChainGun() throws AttachmentException, WeaponException
	{
		...
		assertEquals(22, powerScopeChain.fire(15)); 
		timer.timeChanged();
		
		//test at base.maxRange (30)
		//ChainGun damage is max: 15
		//with Scope: 15*(1+((35-30)/35) = 17
		//with PowerBooster: 17*(1+(34/35) = 35
		assertEquals(35, powerScopeChain.fire(30)); 
		timer.timeChanged();
		...
		//test at base.maxRange (30)
		//ChainGun damage is max: 15
		//with Scope: 15*(1+((35-30)/35) = 18
		//with PowerBooster: 18*(1+(22/40) = 27
		assertEquals(27, powerScopeChain.fire(30)); 
		timer.timeChanged();
		...
		//ChainGun damage is max: 15
		//with Scope: 15*(1+((35-30)/35) = 18
		//with PowerBooster: 18*(1+(7/40) = 20
		assertEquals(20, powerScopeChain.fire(30)); 
		timer.timeChanged();
	}
	...
	public void testPowerBoosterStabilizerChainGun() throws AttachmentException, WeaponException
	{
		...
		//fire the ChainGun once at something in range (315)
		//damage should be 7 = 15*15/30
		//with Stabilizer: 7*1.25 = 8
		//with the powerBooster, damage should be 8*(1+(40/40) = 16
		assertEquals(16, powerStabilizerChain.fire(15)); 
		timer.timeChanged();
		...
		assertEquals(35, powerStabilizerChain.fire(30)); 
		timer.timeChanged();
		...
		assertEquals(27, powerStabilizerChain.fire(30)); 
		timer.timeChanged();
		...
		assertEquals(20, powerStabilizerChain.fire(30)); 
		timer.timeChanged();
	}
	...
	public void testPowerBoosterPowerBoosterChainGun() throws AttachmentException, WeaponException
	{
		...
		assertEquals(28, powerPowerChain.fire(15)); 
		timer.timeChanged();
		...
		assertEquals(57, powerPowerChain.fire(30)); 
		timer.timeChanged();
		...
		assertEquals(35, powerPowerChain.fire(30)); 
		timer.timeChanged();
		...
		assertEquals(19, powerPowerChain.fire(30)); 
		timer.timeChanged();
	}
}
